{ url: 'https://top.baidu.com/board?platform=pc&sa=pcindex_a_right', type: 'web', reg_t: '<div class="c-single-text-ellipsis">(.*?)</div>',reg_u: '<div class="c-single-text-ellipsis">(.*?)</div>',pre_u: 'https://chat.baidu.com/search?word=',name: '百度热榜', list: 'hmd',int: "600"}
