{ url: 'https://www.jssjw.gov.cn/col/col232/index.html', type: 'web', reg_t: 'href=".*?" class="bt_link" title="(.*?)" target="_blank">',reg_u: 'href="(.*?)" class="bt_link" title=".*?" target="_blank">',pre_u: 'https://www.jssjw.gov.cn',name: '清风扬帆', list: 'hmd',int: "300"},
