{ url: 'https://www.jssjw.gov.cn/col/col232/index.html', type: 'web', reg_t: '<span class="list_news_bt"><a href=".*?" target="_blank">(.*?)</a>',reg_u: '<span class="list_news_bt"><a href="(.*?)" target="_blank">.*?</a>',pre_u: 'https://www.lianshi.gov.cn/',name: '廉石', list: 'hmd',int: "600"},
{ url: 'https://www.lianshi.gov.cn/NewsList/16.html', type: 'web', reg_t: 'href=".*?" class="bt_link" title="(.*?)" target="_blank">',reg_u: 'href="(.*?)" class="bt_link" title=".*?" target="_blank">',pre_u: 'https://www.jssjw.gov.cn',name: '清风扬帆', list: 'hmd',int: "600"},
